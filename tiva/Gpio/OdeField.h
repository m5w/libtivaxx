...
class OdeField : public EnumeratedField<Field<std::uint32_t, 1>> {
public:
...
private:
  ...
  constexpr explicit OdeField(const FieldType &FieldField)
...
public:
  ...
  static constexpr auto Disabled() { return OdeField(FieldType::make<0>()); }

  static constexpr auto Enabled() { return OdeField(FieldType::make<1>()); }
};
